...
@section('content')
    ...
    <div class="page-header">
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a href="{{ route('users.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i> Quay
                lại</a>
        </div>
    </div>
        ...
        <div class="card-body p-0">
            <table class="table table-borderless mb-0">
                <tbody>
                    ...
                    <tr>
                        <th>Vai trò</th>
                        <td><span class="badge bg-info text-dark">{{ $user->role?->display_name }}</span></td>
                    </tr>
                    <tr>
                        <th>Đại lý</th>
