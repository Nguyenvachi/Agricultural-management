                    ...
                    <tbody>
                        @forelse ($users as $user)
                            <tr>
                                ...
                                <td><span
                                        class="badge bg-info text-dark">{{ $user->role?->display_name ?? $user->role?->code }}</span>
                                </td>
                                ...
                                <td class="text-center text-nowrap">
                                    <div class="d-inline-flex gap-1 flex-wrap justify-content-center">
                                        <a href="{{ route('users.show', $user) }}" class="btn btn-outline-info btn-sm"><i
                                                class="bi bi-eye"></i></a>
                                        <a href="{{ route('users.edit', $user) }}" class="btn btn-outline-warning btn-sm"><i
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center text-muted py-3">Chưa có người dùng</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
