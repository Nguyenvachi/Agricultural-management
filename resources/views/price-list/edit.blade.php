...
<div class="page-header">
    ...
    <a href="{{ route('price-lists.show', $priceList) }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i> Quay lại</a>
</div>
            ...
            <div class="mb-4">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="is_active" value="1"
                           id="isActive" {{ old('is_active', $priceList->is_active) ? 'checked' : '' }}>
