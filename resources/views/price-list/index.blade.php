                ...
                <tbody>
                    @forelse ($priceLists as $priceList)
                        ...
                        <tr>
                            ...
                            <td class="text-end fw-semibold">{{ number_format((float) $priceList->price, 0, ',', '.') }}
                            </td>
                            ...
                            <td class="text-center text-nowrap">
                                <div class="d-inline-flex gap-1 flex-wrap justify-content-center">
                                    <a href="{{ route('price-lists.show', $priceList) }}" class="btn btn-outline-info btn-sm">
                                        <i class="bi bi-eye"></i>
                                    </a>
                                    ...
                                    <form action="{{ route('price-lists.destroy', $priceList) }}" method="POST"
                                        class="d-inline" onsubmit="return confirm('Ngừng hiệu lực bảng giá này?')">
                                        @csrf
                                        @method('DELETE')
