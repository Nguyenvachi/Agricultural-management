...
<div class="page-header">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('categories.edit', $category) }}" class="btn btn-warning btn-sm"><i class="bi bi-pencil"></i> Sửa</a>
...
<div class="card shadow-sm" style="max-width:420px;">
    <div class="card-body p-0">
        <table class="table table-borderless mb-0">
            <tbody>
                <tr><th width="120">ID</th><td>{{ $category->id }}</td></tr>
                <tr><th>Mã</th><td><code>{{ $category->code }}</code></td></tr>
