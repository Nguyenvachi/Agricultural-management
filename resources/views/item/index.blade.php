                ...
                @forelse ($items as $item)
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('items.show', $item) }}" class="btn btn-outline-info btn-sm"><i class="bi bi-eye"></i></a>
                            <a href="{{ route('items.edit', $item) }}" class="btn btn-outline-warning btn-sm"><i class="bi bi-pencil"></i></a>
